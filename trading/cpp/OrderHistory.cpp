...
int main()
{
  ...
  symbol
      string, trading pair, separated by ":"
      optional
  ...
  */
  std::string payload = "{\"symbol\": \"ETH:USDT\", \"nonce\": 1577836800000, \"signature\": \"0x1234abcd\"}";

  // set the url
  std::string url = "https://api.deversifi.dev/v1/trading/r/orderHistory";
