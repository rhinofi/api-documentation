...
export const LibrariesExamplesSection = () => (
  <TutorialSection title="Libraries and Examples">
    ...
    <Text>
      A series of <GreenLink href="https://github.com/rhinofi/@rhino.fi/client-js/tree/master/examples">examples in javascript</GreenLink> make it easy to understand the blockchain steps required.
    </Text>
  </TutorialSection>
);
